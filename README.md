# Illinois Compiled Statutes by citation
...
## Why this was rejected twice first
...
200 with no `Sec.` heading — detected structurally.

## Data source

Illinois General Assembly. Statutes are public record.
